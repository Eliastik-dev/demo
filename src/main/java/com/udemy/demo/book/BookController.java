...
public class BookController {
    ...
    public ResponseEntity addBook(@RequestBody @Valid Book book, Principal principal) {
        ...
        if (category.isPresent()) {
            ...
            return new ResponseEntity("Vous devez renseigner une catégorie valide", HttpStatus.BAD_REQUEST);
        }
        if (user.isPresent()) {
            book.setUser(user.get());
        } else {
            return new ResponseEntity("Vous devez renseigner un utilisateur valide", HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity deleteBook(@PathVariable("bookId") String bookId) {
        ...
        if (!bookToDelete.isPresent()) {
            return new ResponseEntity("Livre introuvable", HttpStatus.BAD_REQUEST);
        }
